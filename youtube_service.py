...
class YouTubeService:
    ...
    def get_user_playlists(self):
        ...
        try:
            ...
            # Add Watch Later playlist (Note: YouTube API has limited access to Watch Later)
            playlists.append({
                'id': 'WL',
                'title': 'Watch Later',
                'description': 'Note: YouTube API has limited access to Watch Later playlist. Use your custom playlists instead.',
                'thumbnail': '',
                'video_count': 0,
                'is_special': True
            })
            logging.info("Added Watch Later playlist (API limitation - shows 0 videos)")
